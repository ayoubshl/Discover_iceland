...
<head>
    ...
    <script defer src="./javaScript/index.js">
...
<body>
                        ...
                        while ([$id, $titre, $date] = mysqli_fetch_row($result)) {
                            ...
                            echo "<tr>
                                        <td>
                                            ...
                                            <a class='link details' id='clickHere' data-number='$id' href='#'>Cliquez ici pour plus de details</a>
                                        </td>
                                    </tr>";
                        }
    ...
    text-decoration: none;
    font-weight: bold;
    margin-top: 15px;" href="signup.php">S'inscrire à la newsletter</a><br>
                <a 
                 style="    display: block;
    text-align: center;
    font-family: arial;
    ...
    text-decoration: none;
    font-weight: bold;
    margin-top: 5px;" href="logIn.php">Se connecter</a>
            </div>
        </div>
        <!--  -->
    </div>
